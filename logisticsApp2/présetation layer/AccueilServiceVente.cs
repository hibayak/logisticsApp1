...
namespace logisticsApp2.présetation_layer
{
...

    {
        ...
        string[] arayBatna = { "Aïn Djasser", "Aïn Touta", "Arris", "Barika", "Batna", "Bouzina", "Chemora", "Djezzar", "El Madher", "Ichmoul", "Menaa", "Merouana", "N'Gaous", "Ouled Si Slimane", "Ras El Aioun", "Seggana", "Seriana", "Tazoult", "Teniet El Abed", "Timgad", "T'kout" };
    ...
    "Zéralda"
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "Batna":
                    foreach (string daira in arayBatna)
                    {
                        comboBox4.Items.Add(daira);
                    }
                    break;
                case "Constantine ":
                    foreach (string daira in arayConstantine)
                    {
                        comboBox4.Items.Add(daira);
                    }
                    break;
                case "Sétif":
                    foreach (string daira in araySétif)
                    {
                        comboBox4.Items.Add(daira);
                    }
                    break;
                case "Alger":
                    foreach (string daira in arayAlger)
                    {
                        comboBox4.Items.Add(daira);
                    }
                    break;
        ...
        private void btnColabsAppro_Click(object sender, EventArgs e)
        {
            if (panelside.Visible == true)
            {
                //panelside.Width = 100;
                //panelside.Height = 692;
        ...
        private void btnColabsGSTK_Click(object sender, EventArgs e)
        {
                if (NaveBarreGSTK.Width == 210)
            {
                NaveBarreGSTK.Width = 100;
                NaveBarreGSTK.Height = 660;
                headerNVBGSTK.Visible = false;
            }
            else
            {
                NaveBarreGSTK.Width = 210;
                NaveBarreGSTK.Height = 660;
                headerNVBGSTK.Visible = true;
            }
        }

        private void dataGridViewexcelProduction_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void Planification_Click(object sender, EventArgs e)
        {
            ...
            {
                connection111 = new OLEDBConnection("Provider= Microsoft.ACE.OLEDB.14.0  ; Data Source=" + op.FileName + " ; Extended Propreties =Excel 14.0");
            }
        }
    }
}    
